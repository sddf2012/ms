...
public enum RespMessageEnum {
    ...
    FEIGN_ERROR("00100","feign调用异常:{0}!"),
    FEIGN_RESP_NULL("00101", "调用{0}模块{1}接口返回体为空!"),
    FEIGN_RESP_VALUE_NULL("00102", "调用{0}模块{1}接口返回值为空!"),
    FEIGN_RESP_ERROR("00103", "调用{0}模块{1}接口返回异常信息:{2}!"),
    FEIGN_INVOKE_ERROR("00104", "调用{0}模块{1}接口异常:{2}!"),
    /**
     * 商品模块
     */
